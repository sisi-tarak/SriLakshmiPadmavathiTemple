...
const Footer = () => {
  return (
    <footer className="w-full  rounded-md bg-[#C0322E] text-white py-8 px-4 mb-0 font-montserrat">
      <Container maxWidth="lg" className="container mx-auto">
        <div className="grid grid-cols-2 lg:items-center lg:grid-cols-5 xl:grid-cols-6 lg:gap-8">
          <div className="col-span-2 md:col-span-2 lg:col-span-1 xl:col-span-2 md:mb-6 mx-auto">
            <div className="flex flex-row justify-center md:justify-start items-start gap-x-5 w-full mb-4 text-sm xs:text-base">
              <p className="font-bold mb-2 w-1/3 lg:w-full xl:w-1/3">Address:</p>
            ...
            <div className="flex flex-row justify-start items-start gap-x-5 w-full text-sm xs:text-base">
              <p className="font-bold mb-2 w-1/3 lg:w-full xl:w-1/3">Phone No:</p>
              <p className="text-white w-2/3 lg:w-full xl:w-2/3">+91 9655214532</p>
            </div>
          </div>
          <div className="col-span-2 lg:col-span-2 xl:col-span-2 grid grid-cols-2 gap-4 mx-auto xl:w-full my-3 xs:my-6 lg:my-0">
            <div className="col-span-1">
              ...
              <ul className="space-y-3">
                <li>
                  <Link to="#" className="text-sm text-white hover:text-white/80 transition-all duration-100 ease-in-out">
                    About Us
                  </Link>
                </li>
                <li>
            ...
            <div className="col-span-1">
              <h3 className="font-bold mb-6">Help & Support</h3>
              <ul className="space-y-3">
                <li>
                  <Link to="#" className="text-sm text-white hover:text-white/80 transition-all duration-100 ease-in-out">
                    Faq
            ...
            <div className="flex flex-col">
              ...
              <div className="mt-10">
                ...
                <div className="flex flex-wrap gap-3">
                  ...
                  {/* You can add more payment buttons here if needed */}
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="border-t border-secondaryColor mt-8 pt-4 text-center text-white">
          <p className="flex flex-col sm:flex-row items-center justify-center gap-y-2 sm:gap-x-1 text-sm">
            <span className="font-semibold">Copyright 2025 Sipptempletpt.org</span>
