  ...
  return (
    <>
      <div className="w-full h-screen h-dvh h-svh flex flex-col justify-center items-center pb-14">
        ...
        <div
          id="home"
          className="w-full flex flex-col-reverse md:flex-row items-center  justify-evenly align-center my-auto"
        >
          <div className="flex flex-col gap-2">
            <h1 className="text-2xl md:text-5xl font-playFair text-mainColor">
